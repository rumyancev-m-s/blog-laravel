...
], 'public/assets/user/js/aside.js');

mix.copyDirectory('resources/assets/user/fonts/icomoon', 'public/assets/user/fonts');
mix.copyDirectory('resources/assets/user/fonts/open-iconic', 'public/assets/user/fonts');